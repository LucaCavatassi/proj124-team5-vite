	...
	<div v-if="screenSize === 'large'" class="container">
		<div class="row">
			<div class="col-4 py-5" v-for="featured in this.paginatedFeatured">
				<div class="card">
					<img
						src="https://www.apartments.com/blog/sites/default/files/styles/x_large_hq/public/image/2023-06/ParkLine-apartment-in-Miami-FL.jpg?itok=kQmw64UU"
						class="card-img-top"
						alt=""
					/>
					<div class="card-body">
			...
			<div class="col-12 py-5" v-for="featured in this.allFeatured">
				<div class="card">
					...
					<div class="card-body">
						...
						<!-- <router-link :to="{ name: 'single-result', params: { slug: store.searchResults.slug } }"
                            class="btn btn-primary ms_btn">Scopri di più</router-link> -->
					</div>
				</div>
			</div>
